        ...
        <div className="flex ">
          {inputColumnVisible ? (
            <input
              type="text"
              ref={inputColumnRef}
              className="flex-grow h-12  w-72 p-2 border-2 border-solid rounded-lg border-purple-200 focus:outline-none"
            ...
            <button
              className="border-transparent flex justify-center items-center h-10 w-72 p-2 mt-2 font-bold bg-purple-50 border-purple-100  text-purple-400 hover:text-white hover:bg-purple-500 hover:border-purple-500 border-2 hover:border-solid rounded-lg transition-all duration-300 "
              onClick={() => {
                setInputColumnVisible(!inputColumnVisible);
              }}
            >
