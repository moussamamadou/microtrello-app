    ...
    <Draggable draggableId={props.column.id} index={props.index}>
      {(provided, snapshot) => (
        <div
          ...
          className={`${
            snapshot.isDragging ? "bg-purple-50y border-purple-400" : "bg-white"
          } flex flex-col gap-2 bg-white rounded-lg w-72 border-2 border-solid p-3 m-2 border-transparent hover:border-purple-200 transition-all duration-300`}
        >
          <div
          ...
          >
            {titleVisible ? (
              ...
              <input
                type="text"
                ref={inputRef}
                className="flex-grow  p-2 border-2 border-solid rounded-lg border-purple-200 focus:outline-none"
                value={inputValue}
            ...
            <Menu as="div" className="relative flex flex-col align-right">
              <Menu.Button className="flex border-2  text-gray-500 bg-white border-transparent hover:border-purple-200 rounded-lg w-10 h-10 justify-center align-center">
                <DotsHorizontal />
              </Menu.Button>
              <Transition
                as={Fragment}
              ...
              >
                <Menu.Items className="z-10 absolute right-0 w-56 mt-12 p-2 origin-top-right bg-white rounded-lg shadow-xl ring-2 ring-purple-100 ring-opacity-60 focus:outline-non">
                  <Menu.Item>
                    {({ active }) => (
                      <button
                        type="button"
                        className="flex items-center relative font-medium p-2 w-full rounded-lg    hover:bg-purple-50 hover:text-purple-400 transition-colors duration-300"
              ...
              >
                ...
                {inputRowVisible ? (
                  <input
                    type="text"
                    ref={inputColumnRef}
                    className="flex-grow h-12  w-full p-2 border-2 border-solid rounded-lg border-purple-200 focus:outline-none"
                    value={inputRowValue}
                  ...
                  <button
                    className="border-transparent flex justify-center items-center h-10 w-full p-2 mt-2 font-bold bg-purple-50 border-purple-100  text-purple-400 hover:text-white hover:bg-purple-500 hover:border-purple-500 border-2 hover:border-solid rounded-lg transition-all duration-300 "
                    onClick={() => {
                      setInputRowVisible(!inputRowVisible);
