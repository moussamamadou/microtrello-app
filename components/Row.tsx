    ...
    <Draggable draggableId={props.row.id} index={props.index}>
      {(provided, snapshot) => (
        <div
          ...
          className={`${
            snapshot.isDragging ? "border-purple-400" : "border-purple-100"
          }
        ...
        >
          <div className="flex justify-between w-full gap-2">
            ...
            >
              <Menu.Button className="z-0 flex border-2  text-gray-500 bg-white border-transparent hover:border-purple-200 rounded-lg w-10 h-10 justify-center align-center">
                <DotsHorizontal />
              </Menu.Button>
              <Transition
                as={Fragment}
              ...
              >
                <Menu.Items className="z-10 absolute right-0 w-56 mt-12 p-1 origin-top-right bg-white rounded-lg shadow-lg ring-2 ring-purple-100 ring-opacity-60 focus:outline-non">
                  <Menu.Item>
                    {({ active }) => (
                      <button
                        type="button"
                        className="flex items-center relative font-medium p-2 w-full rounded-lg   text-gray-500  hover:bg-purple-50 hover:text-purple-400 transition-colors duration-500"
